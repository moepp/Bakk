...
\newcommand{\myfiguresizewidth}{0.3}   
%% e.g., 10pt, 11pt, 12pt
%% The font size of the main text in pt (points).

\newcommand{\myfiguresizeheigth}{0.3}   
%% e.g., 10pt, 11pt, 12pt
%% The font size of the main text in pt (points).
...
%% general metadata:
\newcommand{\myauthor}{Stephan Moser}  %% also used for PDF metadata (hyperref)
\newcommand{\mytitle}{iPhone App Additions- und Subtraktionstrainer}  %% also used for PDF metadata (hyperref)
\newcommand{\mysubject}{iPhone App Additions- und Subtraktionstrainer}  %% also used for PDF metadata (hyperref)
\newcommand{\mykeywords}{iOS, iPhone, Addition, Subtraktion, Trainer}  %% also used for PDF metadata (hyperref)

%% this information is used only for generating the title page:
\newcommand{\myworktitle}{Bachelor Arbeit}  %% official type of work like ``Master theses''
\newcommand{\mygrade}{Bachelor of Science} %% title you are getting with this work like ``Master of ...''
\newcommand{\mystudy}{Softwareentwicklung - Wirtschaft} %% your study like ``Arts''
\newcommand{\myuniversity}{Technische Universitat Graz} %% your university/school
\newcommand{\myinstitute}{Institut für Informationssysteme und Computer Medien} %% affiliation
\newcommand{\myinstitutehead}{Univ.-Prof.\,Dipl-Ing.\,Dr.techn.~Frank Kappe} %% head of institute
\newcommand{\mysupervisor}{Univ.-Doz.\,Dipl-Ing.\,Dr.techn.~Martin Ebner} %% your supervisor
\newcommand{\myevaluator}{Prof.~Some Genius} %% your evaluator
\newcommand{\myhomestreet}{Am Arlandgrund~55/3} %% your home street (with house number)
\newcommand{\myhometown}{Graz} %% your home town
\newcommand{\myhomepostalnumber}{8045} %% your postal number of home town
...
\newcommand{\myid}{0730441} %% Matrikelnummer
