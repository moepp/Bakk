...
% add or modify language parameter of package Â\UTF{00AA}babelÂ« and use language switches described in babel-documentation
...
%doc% \item Unicode-support like German umlauts (Ã¶, Ã¤, Ã\UTF{00BA}, Ã\UTF{00FC}) for references
